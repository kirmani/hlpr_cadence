...
void objectPoseTF(geometry_msgs::Transform geom_transform,int frame_id=0)
{
  ...
  std::string child_frame_id = "object" + std::to_string(frame_id);
  //std::cout << "publishing transform for " << child_frame_id << endl; 
